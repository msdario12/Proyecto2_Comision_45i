...
<button id="showAllUsers" class="btn btn-secondary">
	Todos los usuarios
</button>
<button id="showHostUsers" class="btn btn-primary">Anfitriones</button>
<button id="showGuestsUsers" class="btn btn-dark">Huéspedes</button>
`;
